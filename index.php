    ...
    <main role="main">
        ...
        <section class="jumbotron text-center kk text-light">
          <div class="container">
            ...
            <p class="lead text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem, fuga distinctio quos velit modi minima commodi, nobis nam ea tempore facere voluptatum quod porro, rerum perspiciatis ducimus esse excepturi natus.</p>
            <p>
